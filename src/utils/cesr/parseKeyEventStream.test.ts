    ...
    const parsedCesr = [
      {
        v: 'KERI10JSON00012b_',
        t: 'icp',
        d: 'EKu2gkyoKhVsQBZEeYgp9SwGOl0PKnH4HvB10dkqC7lB',
        i: 'EKu2gkyoKhVsQBZEeYgp9SwGOl0PKnH4HvB10dkqC7lB',
        s: '0',
        kt: '1',
        k: ['DEx0lnNR0WmphGiX-4FYv1-2iKxKph74lqi0V3KDdLKP'],
        nt: '1',
        n: ['EA1aDFBBlSc3lZe_IQqBYr6XV8-YDYWwyLIVmtm5Lng5'],
        bt: '0',
        b: [],
        c: [],
        a: [],
      ...
      },
      {
        v: 'KERI10JSON00013a_',
        t: 'ixn',
        d: 'ECL68Dfi9APmL94VF_A04tkx5f3ZxHTuznv9KF8CRvEm',
        i: 'EFCwLHkNR2UAZrDHBd09iNzbzqdLy2hozJVL3swdd1dB',
        s: '1',
        p: 'EFCwLHkNR2UAZrDHBd09iNzbzqdLy2hozJVL3swdd1dB',
        a: [
          {
