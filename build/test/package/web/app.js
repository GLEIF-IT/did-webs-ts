...
const checkCompose = () =>
  didWebs.composeDid(
    'example.com',
    'EFGDbi1kexM1ccTA_YSvTo9yW2eGx9BD6lmNNP5O-1Uo',
    '/path/to/dids',
    8080
  ) ===
    'did:webs:example.com%3A8080:path:to:dids:EFGDbi1kexM1ccTA_YSvTo9yW2eGx9BD6lmNNP5O-1Uo' &&
  composeDid(
    'example.com',
    'EFGDbi1kexM1ccTA_YSvTo9yW2eGx9BD6lmNNP5O-1Uo',
    '/path/to/dids',
...
const checkPublish = () => {
  ...
  // Check default export: D
  const [didJsonD, keriCesrD, didD] = didWebs.publishDid(cesr, {
    host: 'example.com',
    port: 8080,
    path: '/identity/did',
  });

  // Check named export: N
  const [didJsonN, keriCesrN, didN] = publishDid(cesr, {
    host: 'example.com',
    port: 8080,
    path: '/identity/did',
  });
  ...
  return (
    didWebs.compareDidDocuments(didJsonD, document) &&
    didWebs.compareDidDocuments(didJsonN, document) &&
    keriCesrD === cesr &&
    keriCesrN === cesr &&
    didD ===
      'did:webs:example.com%3A8080:identity:did:ECwJlFWWcXQRwMDP80dmDgEO949AqKOSR2sTGFli9aSc' &&
